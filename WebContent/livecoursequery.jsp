									...
									<s:iterator value="listCourse" status="ste">
											<tr>
												...
												<td width="15%">
												 ...
												 <a class="btn btn-success btn-rounded" href="javascript:void(0)" onClick="showinfo('<s:property value="course.id"/>'">修改</a>
												 <a class="btn btn-danger btn-rounded" href="javascript:void(0)" onClick="showinfo('<s:property value="course.id"/>'">删除</a>
												</td>											
											</tr>
									</s:iterator>	
                            </tbody>
...
function findCourse(){
	  ...
	  layer.close(index);
	  window.location="student_findByName.action?courseName="+value; 
	});
}
</script>
</html>
