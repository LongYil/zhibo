			...
			<div class="col-sm-6" style="width:100%;">
                <div class="ibox float-e-margins" style="width:60%;margin:0 auto;"> 
                    <div class="ibox-title" >
                        ...
                        <div class="fa-hover col-md-3 col-sm-4" style="color:#23b7e5;font-size:20px;width:120px;float:right;margin-right:0px;"><a onClick="Go('exam_findAll.action')" href="javascript:void(0)"><i class="fa fa-mail-reply"></i> 返回 <span class="text-muted"></span></a></div>                        
                    </div>
                    <div class="ibox-content">
                        <div class="form-horizontal">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text-area" name="describes" placeholder="试题描述" class="form-control"> 
                                </div>
                            </div>
