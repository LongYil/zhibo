...
public class ServerInfo {
	...
	public static final String SERVER_IP2 = "120.78.208.115";
	
//	public static final String SERVER_IP = "localhost:8080";
//	public static final String SERVER_IP2 = "localhost";
	...
	public static final String DBNAME = "collegelive";
	public static final String DBUSER = "root";
	public static final String DBPASS = "neighbour123";
